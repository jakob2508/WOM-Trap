...
# We expect ~1M neutrinos from a 10 kpc SN in standard IceCube
sig_IC86 = 1E6
# noise_rate * number of modules
f_noise_IC86 = 550 * 5160
...
def allocator(sensor_type, update_type, SN_type, noise_type):
    if sensor_type == 'DOM':
        number_of_PMTs = 1
        signal_events = sig_IC86
        noise_rate = f_noise_IC86
    elif sensor_type == 'mDOM':
